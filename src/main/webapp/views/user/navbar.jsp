        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            ...
            <button class="navbar-toggler collapsed" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
                ...
                <div class="last_list">
                    ...
                    <a class="text-decoration-none cart icon position-relative" href="${pageContext.request.contextPath}/cart"><img src="${pageContext.request.contextPath}/static/img/ff.png" alt="image" class="img-fluid"><span id="cartIcon">${empty cart ? 0 : cart.size()}</span></a>
                    <%
